...
const AuthenticatedRoutes = () => {
    return (
        <Routes>
            ...
            <Route path="/reporting/referral-schedule" element={<AnticipatedEAOSchedule />} />
            <Route path="/reporting/resource-forecast" element={<ResourceForecast />} />
            <Route path="/reporting/thirty-sixty-ninety" element={<ThirtySixtyNinety />} />
