...
describe("WorkList", () => {
  ...
  it("should filter the work list based on the work name input", () => {
    testTableFiltering("Name", work1.title);
    cy.get("table").contains("tr", work1.title).should("be.visible");
    cy.get("table").contains("tr", work2.title).should("not.exist");
  });
});
