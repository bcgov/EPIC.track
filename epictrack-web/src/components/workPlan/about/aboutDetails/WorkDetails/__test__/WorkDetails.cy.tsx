...
const generateMockMinistry = (): Ministry => ({
  id: faker.number.int(),
  name: faker.lorem.word(),
  minister: {
    id: faker.number.int(),
...
const generateMockListType = (): ListType => ({
  id: faker.number.int(),
  name: faker.lorem.word(),
});
...
const generateMockWorkPhase = (): WorkPhase => ({
...
const generateMockWorkPhaseAdditionalInfo = (): WorkPhaseAdditionalInfo => ({
