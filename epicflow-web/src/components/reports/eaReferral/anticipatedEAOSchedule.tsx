...
import { Accordion, AccordionDetails, AccordionSummary, Alert, Box, Button, FormLabel, Grid, Skeleton, Tab, Table, Tabs, Typography } from '@mui/material';
    ...
    return (
        <>
            <Grid component="form" onSubmit={(e) => e.preventDefault()} container spacing={2} sx={{ marginTop: '5px' }}>
                ...
                <Grid item sm={1}>
                    {resultStatus === RESULT_STATUS.LOADED && <Button variant='contained' onClick={downloadPDFReport}>Download</Button>}
                </Grid>
            </Grid>
