...
public class FormBPMFilteredDataPipelineListenerTest {
    ...
    public void setup() {
        try {
            Field field = formBPMFilteredDataPipelineListener.getClass().getDeclaredField("bpmObjectMapper");
    ...
    public void syncFormVariables_with_delegatetask_and_validapi_withdata_test() throws Exception {
        ...
        formProcessMappingData.setProcessKey("onestepapproval");
        formProcessMappingData.setTaskVariable("[{\"key\" : \"business.business_owner\", \"defaultLabel\" : \"Business Owner\", \"label\" : \"Business Owner\"}]");
        ...
        String submission="{\"data\":{\"business\":{\"business_owner\":\"David\"},\"applicationId\":\"130\",\"applicationStatus\":\"Created\"}}";
        when(formSubmissionService.readSubmission(actualFormUrl))
