...
from epictrack_api.utils import constants
...
CONFIGURATION = {
    'development': 'epictrack_api.config.DevConfig',
    'testing': 'epictrack_api.config.TestConfig',
    'production': 'epictrack_api.config.ProdConfig',
    'default': 'epictrack_api.config.ProdConfig',
    'migration': 'epictrack_api.config.MigrationConfig',
}
