...
from epictrack_api import create_app
from epictrack_api import jwt as _jwt
from epictrack_api.models import Project, Staff
from epictrack_api.models import db as _db
...
patch("epictrack_api.utils.auth.require", mock_decorator, spec=True).start()
