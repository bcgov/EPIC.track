...
def upgrade():
    ...
    op.execute(
        "UPDATE indigenous_works SET indigenous_consultation_level_id = (SELECT id FROM indigenous_consultation_levels WHERE name = 'Other') WHERE indigenous_consultation_level_id is Null"
    )
