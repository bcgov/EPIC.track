...
def upgrade():
    ...
    op.execute("UPDATE work_types SET name = 'Substantial Start Determination' WHERE name = 'Substantial Start Decision'")
    op.execute("UPDATE work_types SET is_active = true WHERE name = 'Substantial Start Determination'")
