...
>Determine the value and feasibility of this solution.
...
| 2  | The solution should use low code technology stack  |
...
| :---:| :---: |:--- |
| 1  | Staff  | The users who access the system for daily work. |
...
This solution make use of the full set of components provided by [formsﬂow.ai](https://github.com/AOT-Technologies/forms-flow-ai)
...
| Nbr  | Component | Description |
| :---:| :---: |:--- |
| A  | IDIR Identity Service  | BC Gov SSO via OIDC's Keycloak for authentication.  Staff users can authenticate with IDIR. |
...
| C  | Central Database | [PostgreSQL](https://www.postgresql.org/) based database for storing information.|

## Technologies Overview

### formsflow.ai

Use [formsﬂow.ai](https://github.com/AOT-Technologies/forms-flow-ai) which is a completely free and open-source framework that integrates intelligent forms, decision making workﬂows, and powerful analytics as the core solution component. This will be further customized and extended to meet the prototype requirements.

### Central Database

This project uses PostgreSQL as its central database, given its broad adoption across BC Gov projects.
...
[Frontend](/epictrack-web/README.md)
[Backend](/epictrack-api/README.md)