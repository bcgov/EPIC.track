...
"""Model to handle all operations related to Task Event Responsibilities."""
...
class TaskEventResponsibility(BaseModelVersioned):
    """Model class for Task Event Responsibilities."""

    __tablename__ = 'task_event_responsibilities'
    ...
    responsibility_id = sa.Column(sa.ForeignKey('responsibilities.id'), nullable=False)
