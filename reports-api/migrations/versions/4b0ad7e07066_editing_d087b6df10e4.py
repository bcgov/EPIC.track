"""editing_d087b6df10e4

Revision ID: 4b0ad7e07066
Revises: d087b6df10e4
Create Date: 2023-04-13 10:47:40.280204
...
revision = '4b0ad7e07066'
down_revision = 'd087b6df10e4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    file_path = Path(__file__, "../../data/002-work_types_update.json")
    ...
    with file_path.resolve().open("r") as f:
        ...
        for _, work_type_data in work_types.items():
            for index, phase in enumerate(work_type_data):
                ...
                query = text(f"SELECT id, sort_order from phase_codes {conditions}")
                ...
                if phase_obj is None:
                    ...
                    if(hasattr(phase,"sort_order")):
                        phase["sort_order"] = phase_sort_order
                        phase["sort_order"] = phase_obj["sort_order"]
                    conn.execute(
                        phase_table.update()
                ...
                for milestone in milestones:
                    ...
                    if milestone_obj is None: 
                        ...
                        if(hasattr(milestone,"sort_order")):
                            milestone["sort_order"] = milestone_sort_order
                            milestone["sort_order"] = milestone_obj["sort_order"]
                        conn.execute(
                    ...
                    if milestone_ref:
                        ...
                        for outcome in outcomes:
                            ...
                            conditions = f"WHERE milestone_id ={milestone_id} AND name='{outcome['name']}'"
                            query = text(
