...
console.log('submission id ',submission_id);
 var app_data = JSON.stringify(application_data).replace(/#submissionid/g, submission_id)
 var application_create_response = http.post(APPLICATION_CREATE_URL, app_data, params);
